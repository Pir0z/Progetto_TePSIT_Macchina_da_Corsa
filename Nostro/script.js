...
let contPointPlayer = 0; // Punteggio del giocatore
let contCarDogde = 10; // Punti per aver schivato l'ostacolo
...
function moveObstacle() {
  ...
  if(carRect.x < obstacleRect.x + obstacleRect.width && carRect.x + carRect.width > obstacleRect.x){
    if(carRect.y < obstacleRect.y + obstacleRect.height && carRect.y + carRect.height > obstacleRect.y){
